						...
						<asp:ListView ID="objectlist" runat="server" DataSourceID="SqlDataSource1" OnItemCommand="objectlist_ItemCommand" OnDataBound="objectlist_DataBound" OnPagePropertiesChanging="objectlist_PagePropertiesChanging">
							<LayoutTemplate>
								<ul>
									...
									<asp:DataPager ID="DataPager1" runat="server" PagedControlID="objectlist" PageSize="3" class="NavigationBar">
										<Fields>
											...
											<asp:NumericPagerField ButtonCount="10" NumericButtonCssClass="pagerclass" CurrentPageLabelCssClass="pagerclass_selected"/>
