...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <img src="Images/logo_sak.png" /><h1>Beskrivning - Lösöre</h1>
    <div class="product_verktyg">
        <img src="Images/logo_verktyg_dator_300_300.png" /><img src="Images/logo_verktyg_kamera_300_300.png" /><img src="Images/logo_verktyg_gps_300_300.png" />
    </div>
    <div class="whitebox"><p>Målet, att underlätta i varje led i hanteringen av lösören är ambitiöst och kräver samarbete mellan individer och bolag. Första steget mot att nå dit är taget i.o.m. EZL-appen. Stora utmaningar ligger i begreppet lösöre omfattar ett stort antal olika saker, en keps, en byrå, två stolar, tre flaskor, en samling frimärken, listan kan göras lång. Den utmaningen klarar EZL bättre än något jämfört system i branschen.      </p>
    ...
    <a href="products.aspx" class="button" style="float:left">&laquo; Tillbaka till produkter</a><a href="product_timeline.aspx#sak_timeline" class="button">Se tidslinje &raquo;</a><div style="clear:both"></div></div>
